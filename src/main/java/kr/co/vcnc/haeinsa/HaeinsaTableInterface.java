...
public interface HaeinsaTableInterface {
	   ...
	   * @since 0.20.0
	   */
	  HaeinsaResult get(HaeinsaTransaction tx, HaeinsaGet get) throws IOException;
...
//	  Result[] get(Transaction tx, List<HaeinsaGet> gets) throws IOException;
	   ...
	   * @since 0.20.0
	   */
	  HaeinsaResultScanner getScanner(HaeinsaTransaction tx, HaeinsaScan scan) throws IOException;
	   ...
	   * @since 0.20.0
	   */
	  HaeinsaResultScanner getScanner(HaeinsaTransaction tx, HaeinsaIntraScan intraScan) throws IOException;
	   ...
	   * @since 0.20.0
	   */
	  HaeinsaResultScanner getScanner(HaeinsaTransaction tx, byte[] family) throws IOException;
	   ...
	   * @since 0.20.0
	   */
	  HaeinsaResultScanner getScanner(HaeinsaTransaction tx, byte[] family, byte[] qualifier) throws IOException;
